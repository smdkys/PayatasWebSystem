...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="kanal.php" class="nav-link">Requests</a>
                <a href="kanal_archive.php" class="nav-link  active">Archives</a>
            </div>
    ...
    <div class="forms">
        ...
        <a href="kanal_archive.php" class="link active">Linis Kanal</a>
