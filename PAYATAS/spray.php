...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="spray.php" class="nav-link active">Requests</a>
                <a href="spray_archive.php" class="nav-link">Archives</a>
            </div>
    ...
    <div class="forms">
        <a href="spray.php" class="link active">Spray</a>
    ...
    <div class="container">
        <h2>Service Request - Spray Forms</h2>
