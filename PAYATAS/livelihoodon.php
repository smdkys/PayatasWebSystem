...
$sql = "SELECT * FROM livelihoodonsiteform WHERE status !='finished' ORDER BY id DESC";
...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
            <a href="livelihoodon.php" class="nav-link active">Requests</a>
            <a href="livelihoodon_archive.php" class="nav-link">Archives</a>
            </div>
    ...
    <div class="forms">
        ...
        <a href="livelihood.php" class="link active">Livelihood</a>
    ...
    <div class="container">
        ...
        <div class="forms">
        <a href="livelihood.php" class="link">Livelihood Off-Site</a>
        <a href="livelihoodon.php" class="link active">Livelihood On-Site</a>
        </div>
            ...
            <?php if(!empty($rows)): ?>
                <?php foreach($rows as $row): ?>
                    <div class="request-card" data-id="<?php echo $row['id']; ?>">
                        <img src="limage4.php?id=<?php echo $row['id']; ?>" alt="ID Image">
    ...
    <script>
        function updateStatus(id, newStatus) {
            fetch('livelihoodon_update_status.php', {
                method: 'POST',
    ...
    fetch(`livelihood_get_request_details2.php?id=${id}`)
        .then(response => {
        ...
        .then(data => {
            ...
            modalDetails.innerHTML = `
                ...
                <div class="modal-images">
                    <img src="limage3.php?id=${data.id}" alt="ID Image" class="modal-img">
                    <img src="limage4.php?id=${data.id}" alt="Additional Image" class="modal-img">
                </div>
