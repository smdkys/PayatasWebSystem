...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="dogcare2.php" class="nav-link active">Requests</a>
                <a href="dogcare2_archive.php" class="nav-link">Archives</a>
            </div>
    ...
    <div class="forms">
        ...
        <a href="dogcare.php" class="link active">Dog Care</a>
    ...
    <div class="container">
        ...
        <div class="forms">
        <a href="dogcare.php" class="link">DogCare Pet-sit</a>
        <a href="dogcare2.php" class="link active">DogCare Turn-in</a>
        </div>
                ...
                <?php foreach($rows as $row): ?>
                    <div class="request-card" data-id="<?php echo $row['id']; ?>">
                        ...
                        <select onchange="updateStatus(<?php echo $row['id']; ?>, this.value)">
                            ...
                            <option value="ongoing" <?php echo $row['status'] == 'ongoing' ? 'selected' : ''; ?>>In Process</option>
