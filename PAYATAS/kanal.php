...
$sql = "SELECT * FROM liniskanal WHERE status !='finished' ORDER BY id DESC";
...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="kanal.php" class="nav-link active">Requests</a>
                <a href="kanal_archive.php" class="nav-link">Archives</a>
            </div>
    ...
    <div class="forms">
        ...
        <a href="kanal.php" class="link active">Linis Kanal</a>
    ...
    fetch(`kanal_get_request_details.php?id=${id}`)
        .then(response => {
        ...
        .then(data => {
            ...
            modalDetails.innerHTML = `
                ...
                <div class="modal-images">
                    <img src="kimage.php?id=${data.id}" alt="ID Image" class="modal-img">
                </div>
