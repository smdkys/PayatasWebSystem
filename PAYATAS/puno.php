...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="puno.php" class="nav-link active">Requests</a>
                <a href="puno_archive.php" class="nav-link">Archives</a>
            </div>
    ...
    <div class="forms">
        ...
        <a href="puno.php" class="link active">Team Puno</a>
    ...
    <div class="container">
        <h2>Service Request - Team Puno Forms</h2>
