...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
            <a href="livelihoodon.php" class="nav-link">Requests</a>
            <a href="livelihoodon_archive.php" class="nav-link active">Archives</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="forms">
        <a href="livelihood_archive.php" class="link">Livelihood Off-Site</a>
        <a href="livelihoodon_archive.php" class="link active">Livelihood On-Site</a>
        </div>
