...
$sql = "SELECT * FROM debrisform WHERE status !='finished' ORDER BY id DESC";
...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="debris.php" class="nav-link active">Requests</a>
                <a href="debris_archive.php" class="nav-link">Archives</a>
            </div>
    ...
    <div class="forms">
        ...
        <a href="debris.php" class="link active">Debris</a>
    </div>

    <div class="container">
        <h2>Service Request - Debris Forms</h2> 
        <div class="request-grid" id="requestGrid">
            <?php if(!empty($rows)): ?>
                <?php foreach($rows as $row): ?>
                    <div class="request-card" data-id="<?php echo $row['id']; ?>">
                        <img src="debimage.php?id=<?php echo $row['id']; ?>" alt="ID Image">
    ...
    <script>
        ...
        function updateStatus(id, newStatus) {
            fetch('debris_update_status.php', {
                method: 'POST',
    ...
    fetch(`debris_get_request_details.php?id=${id}`)
        .then(response => {
        ...
        .then(data => {
            ...
            modalDetails.innerHTML = `
                ...
                <div class="modal-images">
                    <img src="debimage.php?id=${data.id}" alt="ID Image" class="modal-img">
                </div>
