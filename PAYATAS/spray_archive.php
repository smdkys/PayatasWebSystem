...
$sql = "SELECT * FROM sprayform WHERE status = 'finished' ORDER BY id DESC";
...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="spray.php" class="nav-link">Requests</a>
                <a href="spray_archive.php" class="nav-link active">Archives</a>
            </div>
    ...
    <div class="forms">
        <a href="spray_archive.php" class="link active">Spray</a>
    ...
    fetch(`spray_get_request_details.php?id=${id}`)
        .then(response => {
        ...
        .then(data => {
            ...
            modalDetails.innerHTML = `
                ...
                <img src="simage.php?id=${data.id}" alt="ID Image" style="max-width: 100%; height: auto; margin-bottom: 15px;">
