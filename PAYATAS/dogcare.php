...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="dogcare.php" class="nav-link active">Requests</a>
                <a href="dogcare_archive.php" class="nav-link">Archives</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="forms">
        <a href="dogcare.php" class="link active">DogCare Pet-sit</a>
        <a href="dogcare2.php" class="link">DogCare Turn-in</a>
        </div>
