...
$sql = "SELECT * FROM turninform WHERE status ='finished' ORDER BY id DESC";
...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="dogcare2.php" class="nav-link">Requests</a>
                <a href="dogcare2_archive.php" class="nav-link active">Archives</a>
            </div>
    ...
    <div class="forms">
        ...
        <a href="dogcare_archive.php" class="link active">Dog Care</a>
        <a href="livelihood_archive.php" class="link">Livelihood</a>
        <a href="debris_archive.php" class="link">Debris</a>
    </div>

    <div class="container">
        <h2>Service Request - DogCare Pet-sit Forms</h2>
        <div class="forms">
        <a href="dogcare_archive.php" class="link">DogCare Pet-sit</a>
        <a href="dogcare2_archive.php" class="link active">DogCare Turn-in</a>
        </div>
            ...
            <?php if(!empty($rows)): ?>
                <?php foreach($rows as $row): ?>
                    <div class="request-card" data-id="<?php echo $row['id']; ?>">
                        <img src="dimage2.php?id=<?php echo $row['id']; ?>" alt="ID Image">
    ...
    <script>
        function updateStatus(id, newStatus) {
            fetch('dogcare2_update_status.php', {
                method: 'POST',
    ...
    fetch(`dogturn_get_request_details.php?id=${id}`)
        .then(response => {
        ...
        .then(data => {
            ...
            modalDetails.innerHTML = `
                ...
                <div class="modal-images">
                    <img src="dimage2.php?id=${data.id}" alt="ID Image" class="modal-img">
                </div>
                <div class="modal-info">
                    ...
                    <p><strong>Number of Pets:</strong> ${data.numberofPets}</p>
                    <p><strong>Pet Type:</strong> ${data.petType}</p>
                    <p><strong>Breed/Mark:</strong> ${data.dogMark}</p>
                </div>
            `;
