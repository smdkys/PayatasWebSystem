...
$sql = "SELECT * FROM petsitform WHERE status ='finished' ORDER BY id DESC";
...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="dogcare.php" class="nav-link">Requests</a>
                <a href="dogcare_archive.php" class="nav-link active">Archives</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="forms">
        <a href="dogcare_archive.php" class="link active">DogCare Pet-sit</a>
        <a href="dogcare2_archive.php" class="link">DogCare Turn-in</a>
        </div>
            ...
            <?php if(!empty($rows)): ?>
                <?php foreach($rows as $row): ?>
                    <div class="request-card" data-id="<?php echo $row['id']; ?>">
                        <img src="dimage.php?id=<?php echo $row['id']; ?>" alt="ID Image">
    ...
    <script>
        function updateStatus(id, newStatus) {
            fetch('dogcare_update_status.php', {
                method: 'POST',
    ...
    fetch(`dogsit_get_request_details.php?id=${id}`)
        .then(response => {
