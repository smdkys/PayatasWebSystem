...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="debris.php" class="nav-link">Requests</a>
                <a href="debris_archive.php" class="nav-link active">Archives</a>
            </div>
    ...
    <div class="forms">
        ...
        <a href="debris_archive.php" class="link active">Debris</a>
    </div>
