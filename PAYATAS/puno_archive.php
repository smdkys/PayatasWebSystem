...
$sql = "SELECT * FROM puno WHERE status = 'finished' ORDER BY id DESC";
...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="puno.php" class="nav-link">Requests</a>
                <a href="puno_archive.php" class="nav-link active">Archives</a>
            </div>
    ...
    <div class="forms">
        ...
        <a href="puno_archive.php" class="link active">Team Puno</a>
    ...
    fetch(`puno_get_request_details.php?id=${id}`)
        .then(response => {
        ...
        .then(data => {
            ...
            modalDetails.innerHTML = `
                ...
                <div class="modal-images">
                    <img src="pimage.php?id=${data.id}" alt="ID Image" class="modal-img">
                    <img src="pimage2.php?id=${data.id}" alt="Additional Image" class="modal-img">
                </div>
