...
<body>
    <header>
        <div class="header">
            ...
            <div class="nav-links">
                <a href="livelihood.php" class="nav-link active">Requests</a>
                <a href="livelihood_archive.php" class="nav-link">Archives</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="forms">
        <a href="livelihood.php" class="link active">Livelihood Off-Site</a>
        <a href="livelihoodon.php" class="link">Livelihood On-Site</a>
        </div>
